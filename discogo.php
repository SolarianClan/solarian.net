<?php
	...
	$memberCount = file_get_contents("https://solarian.net/membercountforbadge.php");
...
<html lang="en" prefix="og: http://ogp.me/ns#">
  <head>       
    ...
    <meta name="description" content="Solarian Clan
...
<?php print_r($memberCount); ?>" />
    ...
    <link rel="shortcut icon" href="https://solarian.net/img/favicon.png" type="image/png"><link rel="icon" href="https://solarian.net/img/favicon.png" type="image/png">
    <!-- Open Graph Tags -->
    <meta property="og:site_name" content="Solarian Clan Discord">
	<meta property="og:url" content="https://solarian.net/discord" />
	<meta property="og:image" content="https://solarian.net/img/sol-discord-icon.png" />
	<meta name="theme-color" content="#9900ff">
	<title>Solarian Clan Discord</title>
	<meta property="og:title" content="Solarian Clan" />
